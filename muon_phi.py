...
def main():
    ...
    xranges={
            'emu/Stage_0/h1_0_emu_phi_muo':[-3.2,3.2],
    }
...
# 
        ...
        if hist in xranges.keys():
            test.Set_axis(logx=False,logy=True,xmin=xranges[hist][0],xmax=xranges[hist][1],ymin=1e-4,ymax=1.1e5)
